				...
				<tbody>
					...
					<c:forEach var="user" items="${listUser}">
						...
						<tr>
							...
							<td><c:out value="${user.article}" /></td>
							<td><c:out value="${user.company}" /></td>
							<td><c:out value="${user.price}" /></td>
							<td><a href="edit?id=<c:out value='${user.id}' />" class="btn btn-outline-danger">Edit</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="delete?id=<c:out value='${user.id}' />" class="btn btn-outline-warning">Delete</a></td>
						</tr>
					</c:forEach>
					<!-- } -->
				</tbody>
